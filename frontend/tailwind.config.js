  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Green-specific shadows
        'emerald-sm': '0 1px 2px 0 rgba(5, 150, 105, 0.1)',
        'emerald-md': '0 4px 6px -1px rgba(5, 150, 105, 0.2)',
        'emerald-lg': '0 10px 15px -3px rgba(5, 150, 105, 0.3)',
        // Focus ring
        'focus': '0 0 0 3px rgba(5, 150, 105, 0.1)',
      },
      borderRadius: {
        'none': '0',
        'sm': '0.25rem',
